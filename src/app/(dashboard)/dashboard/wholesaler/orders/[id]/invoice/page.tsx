        ...
        <div className="p-8 md:p-12 print:p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 print:grid-cols-2 print:mb-6">
            <div>
              ...
              <p className="text-base font-bold text-gray-900">{order.customer?.name || order.name || 'N/A'}</p>
              <p className="text-sm text-gray-600 mt-1">{order.customer?.address || order.address || 'N/A'}</p>
              <p className="text-sm text-gray-600 mt-2 font-medium">Phone: {order.customer?.phone || order.phone || 'N/A'}</p>
            </div>
            <div className="md:text-right">
              ...
              <p className="text-sm text-gray-600 mt-1">Transaction No: {order.transaction_no || 'N/A'}</p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-end border-t-2 border-gray-100 pt-8 print:flex-row print:pt-4">
            <div className="w-full md:w-1/2 lg:w-1/3 space-y-3 print:w-1/2">
              <div className="flex justify-between text-sm">
                ...
                <span className="text-gray-900 font-medium">৳{Number(order.sale_amount).toLocaleString()}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">Shipping (Courier):</span>
                <span className="text-gray-900 font-medium">৳{Number(order.courier_charge).toLocaleString()}</span>
              </div>
              ...
              {order.manual_discount > 0 && (
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-red-600 font-medium">-৳{Number(order.manual_discount).toLocaleString()}</span>
                </div>
              )}
